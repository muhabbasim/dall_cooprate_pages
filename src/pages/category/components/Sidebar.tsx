        ...
        <aside className="col-12 col-xl-3 offset-xl-1 col-lg-4 col-md-7 md:pl-[15px]">
            ...
            <div className='mb-10 xs:mb-[35px]'>
                ...
                {props?.sectors?.map((el: {name: string}) => {
                    return (
                        <li key={el?.name} className='relative inline-block w-full mb-[15px] leading-[18px]'>
            ...
            <div className='mb-20 xs:mb-[35px]'>
                ...
                {sectorOperators?.map((el: {id: string, name: string, logo: string, jobs: number}) => {
                    return (
                        <li key={el?.name} className='flex flex-col gap-3 w-64 h-20 relative mb-[15px] leading-[18px]'>
                            <Link aria-label="link" to="#" className='inline-block text-left'>{el?.name}</Link>
