                    ...
                    props?.bannerData?.map((item: any, i: number) => {
                        ...
                        return (
                            ...
                            <div className="interactivebanners-main" {...{ ...props?.animation, transition: { delay: i * props?.animationDelay } }}>
                                ...
                                <div className="fancy-text-content px-[55px] xs:px-[30px] xxs:px-[30px]">
                                    {item?.major_name && <span style={{ backgroundColor: '#723030'}} className="interactivebanners-subtitle px-[15px] py-[5px] mb-[20px] rounded-[2px] text-white text-xxs font-serif uppercase leading-4 tracking-[1px] inline-block">
                                        <Translatable>
                                            {item?.major_name}
                                        </Translatable>
                                    </span>}
                                    {item?.name && <div className="interactivebanners-title mb-[10px] text-white lg:text-[18px]">
                                        <Translatable>
                                            {item?.name}
                                        </Translatable>
                                    </div>}
